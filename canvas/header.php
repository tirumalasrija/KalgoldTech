		...
		<header id="header" class="full-header">
			...
			<div id="header-wrap" class="">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="<?php echo $url; ?>" class="standard-logo" data-dark-logo="http://canvashtml-cdn.semicolonweb.com/images/logo-dark.png"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
